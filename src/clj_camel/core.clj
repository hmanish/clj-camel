(ns clj-camel.core
  "This library provides a thin wrapper over the Apache Camel Java DSL. The routes are wrtten as clojure vectors
...
(defn apply-route-dsl [root-obj dsl-list]
  (l/info (str "Creating the route: DSL for route --> " (first dsl-list) " ... "))
